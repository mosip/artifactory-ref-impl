...
mvn dependency:get -Ddest=${demosdk_zip_path}/demosdk/ -DremoteRepositories=sonatype-nexus-snapshots::::https://oss.sonatype.org/content/repositories/snapshots -Dartifact=io.mosip.demosdk:demosdk/demosdk:${version}
